...
<div class="form-group @if($errors->get('giro_negocio')) {{'has-error'}} @endif ">
    ...
    <div class="col-sm-7">
        {{ Form::text('giro_negocio',null,array('class'=>'form-control','placeholder'=>'Ingrese Giro del Negocio')) }}
    </div>
</div>
<div class="form-group @if($errors->get('resena_historica')) {{'has-error'}} @endif ">
    ...
    <div class="col-sm-7">
        {{ Form::textarea('resena_historica',null,array('class'=>'form-control','placeholder'=>'Ingrese Reseña Historica')) }}
    </div>
</div>
