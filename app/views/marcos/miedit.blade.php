...
@section("modulo")
<br><br>
<h2 class="page-header">Edición de Marco referencial Internacional</h2>
{{ Form::model($internacional,array('url'=>'internacionalUpdate/' . $internacional->id ,'method'=>'POST','class'=>'form-horizontal marcosutilizar') ) }}
