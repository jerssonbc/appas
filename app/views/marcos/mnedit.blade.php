...
<h2 class="page-header">Edición Marco Referencial Nacional</h2>
{{ Form::model($nacional,array('url'=>'nacionalUpdate/' . $nacional->id ,'method'=>'POST','class'=>'form-horizontal marcosutilizar') ) }}
